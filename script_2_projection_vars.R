...
#slope <- terra::rast("D:/000Frederico/data2/soil/slope.tif") #TWI - Topographic Wetness Index (derivada da variável DEM)
...
#View(as.data.frame(variables_10x10))

################################################################################
#                 RCP 4.5 - CCSM4 (CC)
################################################################################

bio2_cc_45 <- terra::rast("D:/000Frederico/data2/2050/CC/rcp45/cc45bi502.tif")    
bio3_cc_45 <- terra::rast("D:/000Frederico/data2/2050/CC/rcp45/cc45bi503.tif")       
bio13_cc_45 <- terra::rast("D:/000Frederico/data2/2050/CC/rcp45/cc45bi5013.tif")
bio15_cc_45 <- terra::rast("D:/000Frederico/data2/2050/CC/rcp45/cc45bi5015.tif")
#
...
#
nffd_cc_45 <- terra::rast("D:\\000Frederico\\data2\\2050\\CC\\rcp45\\CCSM4_rcp45_2050s_Bioclimatic\\NFFD.asc") 
eref_cc_45 <- terra::rast("D:\\000Frederico\\data2\\2050\\CC\\rcp45\\CCSM4_rcp45_2050s_Bioclimatic\\Eref.asc") 
...
bio2_cn_45 <- terra::rast("D:/000Frederico/data2/2050/CN/rcp45/cn45bi502.tif")    
bio3_cn_45 <- terra::rast("D:/000Frederico/data2/2050/CN/rcp45/cn45bi503.tif")       
bio13_cn_45 <- terra::rast("D:/000Frederico/data2/2050/CN/rcp45/cn45bi5013.tif")
bio15_cn_45 <- terra::rast("D:/000Frederico/data2/2050/CN/rcp45/cn45bi5015.tif")
#
...
#
nffd_cn_45 <- terra::rast("D:\\000Frederico\\data2\\2050\\CN\\rcp45\\NFFD.asc") 
eref_cn_45 <- terra::rast("D:\\000Frederico\\data2\\2050\\CN\\rcp45\\Eref.asc") 
...
bio2_gf_45 <- terra::rast("D:/000Frederico/data2/2050/GF/rcp45/gf45bi502.tif")    
bio3_gf_45 <- terra::rast("D:/000Frederico/data2/2050/GF/rcp45/gf45bi503.tif")       
bio13_gf_45 <- terra::rast("D:/000Frederico/data2/2050/GF/rcp45/gf45bi5013.tif")
bio15_gf_45 <- terra::rast("D:/000Frederico/data2/2050/GF/rcp45/gf45bi5015.tif")
#
...
#
nffd_gf_45 <- terra::rast("D:\\000Frederico\\data2\\2050\\GF\\rcp45\\NFFD.asc") 
eref_gf_45 <- terra::rast("D:\\000Frederico\\data2\\2050\\GF\\rcp45\\Eref.asc") 
...
bio2_had_45 <- terra::rast("D:/000Frederico/data2/2050/HE/rcp45/he45bi502.tif")    
bio3_had_45 <- terra::rast("D:/000Frederico/data2/2050/HE/rcp45/he45bi503.tif")       
bio13_had_45 <- terra::rast("D:/000Frederico/data2/2050/HE/rcp45/he45bi5013.tif")
bio15_had_45 <- terra::rast("D:/000Frederico/data2/2050/HE/rcp45/he45bi5015.tif")
#
...
#
nffd_had_45 <- terra::rast("D:\\000Frederico\\data2\\2050\\HE\\rcp45\\NFFD.asc") 
eref_had_45 <- terra::rast("D:\\000Frederico\\data2\\2050\\HE\\rcp45\\Eref.asc") 
...
bio2_in_45 <- terra::rast("D:/000Frederico/data2/2050/IN/rcp45/in45bi502.tif")    
bio3_in_45 <- terra::rast("D:/000Frederico/data2/2050/IN/rcp45/in45bi503.tif")       
bio13_in_45 <- terra::rast("D:/000Frederico/data2/2050/IN/rcp45/in45bi5013.tif")
bio15_in_45 <- terra::rast("D:/000Frederico/data2/2050/IN/rcp45/in45bi5015.tif")
#
...
#
nffd_in_45 <- terra::rast("D:\\000Frederico\\data2\\2050\\IN\\rcp45\\NFFD.asc") 
eref_in_45 <- terra::rast("D:\\000Frederico\\data2\\2050\\IN\\rcp45\\Eref.asc") 
...
bio2_ip_45 <- terra::rast("D:/000Frederico/data2/2050/IP/rcp45/ip45bi502.tif")    
bio3_ip_45 <- terra::rast("D:/000Frederico/data2/2050/IP/rcp45/ip45bi503.tif")       
bio13_ip_45 <- terra::rast("D:/000Frederico/data2/2050/IP/rcp45/ip45bi5013.tif")
bio15_ip_45 <- terra::rast("D:/000Frederico/data2/2050/IP/rcp45/ip45bi5015.tif")
#
...
#
nffd_ip_45 <- terra::rast("D:\\000Frederico\\data2\\2050\\IP\\rcp45\\NFFD.asc") 
eref_ip_45 <- terra::rast("D:\\000Frederico\\data2\\2050\\IP\\rcp45\\Eref.asc") 
...
bio2_mpi_45 <- terra::rast("D:/000Frederico/data2/2050/MP/rcp45/mp45bi502.tif")    
bio3_mpi_45 <- terra::rast("D:/000Frederico/data2/2050/MP/rcp45/mp45bi503.tif")       
bio13_mpi_45 <- terra::rast("D:/000Frederico/data2/2050/MP/rcp45/mp45bi5013.tif")
bio15_mpi_45 <- terra::rast("D:/000Frederico/data2/2050/MP/rcp45/mp45bi5015.tif")
#
...
#
nffd_mpi_45 <- terra::rast("D:\\000Frederico\\data2\\2050\\MP\\rcp45\\NFFD.asc") 
eref_mpi_45 <- terra::rast("D:\\000Frederico\\data2\\2050\\MP\\rcp45\\Eref.asc") 
